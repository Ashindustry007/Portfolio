            ...
            <TabsContent value="graduate" className="space-y-12">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {academicData.graduate.terms.map((term, idx) => (
                  <div key={idx} className="group p-8 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-primary/30 transition-all duration-500">
            ...
            <TabsContent value="undergrad" className="space-y-12">
              ...
              <div className="grid md:grid-cols-4 gap-6">
                {academicData.undergraduate.semesters.map((sem, idx) => (
                  <div key={idx} className="group p-6 rounded-xl bg-white/[0.02] border border-white/5 hover:border-primary/30 transition-all duration-500">
